package shop.paintball.project.entity.constant;
...
public final class HibernateConstants {
    ...
    public static final String CONSTANTS_TABLE_REVIEWS = "reviews";
    public static final String CONSTANTS_TABLE_ROLES = "roles";
    public static final String CONSTANTS_TABLE_SOCIAL_MEDIA = "social_media";
    public static final String CONSTANTS_TABLE_TOKENS = "tokens";
    public static final String CONSTANTS_TABLE_UPDATES = "updates";
    ...
    public static final String CONSTANTS_COLUMN_ID_INFO_PRODUCT = "id_info_product";
