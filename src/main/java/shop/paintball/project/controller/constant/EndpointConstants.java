...
public final class EndpointConstants {
    ...
    public static final String CONSTANTS_PAGE_ABOUT_US = "about_us_page";
    public static final String CONSTANTS_PAGE_MAIN = "main_page";
    public static final String CONSTANTS_PAGE_CATALOG = "catalog_page";
    ...
    public static final String CONSTANTS_PAGE_PURCHASE_HISTORY = "purchase_history_page";
    public static final String CONSTANTS_REDIRECT_PRODUCT_INFO = "redirect:/showProductInfoPage";
